...
#define S_LOCK "Lock"
#define S_RESTART_DWM "Restart WM"
...
#define S_FORMAT_CLEAR "sed 's/^..//'"
	...
	if (strcmp (exit_action, S_LOCK) == 0) system ("i3lock-fancy -f 'JetBrainsMono-NF-Bold' -- maim & sleep .5; xset dpms force off");
